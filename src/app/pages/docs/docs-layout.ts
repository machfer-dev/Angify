        ...
        <aside class="docs-sidebar">
          <div class="docs-sidebar-inner">
            <div class="docs-sidebar-section">
              ...
              <a routerLink="/docs/overview" routerLinkActive="active" class="docs-sidebar-link">
            ...
            <div class="docs-sidebar-section">
              ...
              @for (item of sidebarItems; track item.route) {
                @if (item.available) {
                  <a [routerLink]="item.route" routerLinkActive="active" class="docs-sidebar-link">
                    <span class="docs-sidebar-dot available"></span>
                    {{ item.label }}
                  </a>
                } @else {
                  <a [routerLink]="item.route" routerLinkActive="active" class="docs-sidebar-link disabled">
